      ...
      <div className="w-full bg-blue-50 rounded-2xl">
        <Disclosure>
          {({ open }) => {
            <>
              <Disclosure.Button
                className="flex justify-center w-full px-4 py-2 text-sm font-medium text-left text-blue-500 bg-blue-100 rounded-lg hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 fucus-visible:ring-opacity-75"
                ref={buttonRef}
              >
                <span>Search ISBN number title.</span>
                <ChevronUpIcon
                  className={
                    '${open ? "transform rotate-180" : "" } w-5 h-5 text-blue-500'
                  }
                />
              </Disclosure.Button>
